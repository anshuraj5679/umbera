...
console.log('system methods:', methods.filter(m => m.startsWith('system_')));
console.log('dryRun methods:', methods.filter(m => m.toLowerCase().includes('dryrun')));
console.log('midnight methods:', methods.filter(m => m.startsWith('midnight_')));
