...
export const orders = pgTable("orders", {
  ...
  encRemainingBaseDepositHandle: text("enc_remaining_base_deposit_handle"),
  encRemainingQuoteDepositHandle: text("enc_remaining_quote_deposit_handle"),
  encRemainingBaseRequestHandle: text("enc_remaining_base_request_handle"),
  encRemainingQuoteRequestHandle: text("enc_remaining_quote_request_handle"),
