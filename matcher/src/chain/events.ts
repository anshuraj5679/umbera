...
export async function indexDexEvent(dex: Contract, db: Db, ev: any, ctx?: IndexContext) {
  ...
  if (name === "OrderSubmitted" || name === "OrderSubmittedPrivate") {
    ...
    await db.insert(orders).values({
      ...
      encRemainingBaseDepositHandle: baseDeposit.toString(),
      encRemainingQuoteDepositHandle: quoteDeposit.toString(),
      encRemainingBaseRequestHandle: baseRequest.toString(),
      encRemainingQuoteRequestHandle: quoteRequest.toString(),
