...
export { isLaceAvailable, connectLace, connectSimulatedLace, isLaceEnabled, disconnectLace, signOrderWithLace, getActiveLaceApi, type MidnightWalletState } from "./wallet";
